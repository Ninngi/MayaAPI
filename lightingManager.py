...
class LightManager(QtWidgets.QWidget):
    ...
    def __init__(self, dock=True):
        ...
        if dock:
            ...
            try:
                ...
                logger.debug('No previus UI exsists')
        ...
        super(LightManager, self).__init__(parent=parent) # do it to stay in front of Maya UI
    ...
    def buildUI(self):
        ...
        for lightTypes in sorted(self.lightTypes):
            self.lightTypeCB.addItem(lightTypes)
    ...
    def saveLights(self):
        ...
        with open(lightFile, 'w') as f:
            json.dump(properties, f, indent=4)  # .json dont give a shit about vectors thou :C
...
class LightWidget(QtWidgets.QWidget):
    ...
    def buildUI(self):
        ...
        intensity.setMaximumWidth(1000)
